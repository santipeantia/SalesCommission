...
public class dbConnect
{
        ...
        public dbConnect()
        {
        //string strPath = HttpContext.Current.Server.MapPath("dbConnectionSQL.txt");
        //var ReadString = File.ReadAllText(strPath);
        ConnectionString = "server=192.168.1.4;database=db_ampelweb;uid=Ampel;pwd=Amp7896321;";
        }
