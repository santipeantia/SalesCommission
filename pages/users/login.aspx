<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="pages_users_login" %>
        ...
        <div class="login-box-body">
            ...
            <form id="frmLogin" runat="server">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-xs-4">
                        <button type="button" id="btnLogin" runat="server" class="btn btn-primary btn-block btn-flat" onserverclick="btnLogin_click">Sign In</button>
                    </div>
                    <!-- /.col -->
