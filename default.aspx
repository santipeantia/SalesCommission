<%@ Page Title="" Language="C#" MasterPageFile="~/salecommission.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="_default" %>
                        ...
                        <div class="box-body">
                            ...
                            <div id="divOption">
                                <div class="user-block">
                                    ...
                                    <span class="username">
                                        <a href="#">Sale Commission [Financial]</a>
            ...
            <div class="modal-dialog"  style="width: 60%">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Sale Commission [Financial]</h4>
                    </div>
                             ...
                             <!-- Post -->
                                        <div class="post clearfix">
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-2 txtLabel">Other/Entertain</div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtRentOther" name="txtRentOther" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                             ...
                                             <div class="row" style="margin-bottom: 5px">                                                                                      
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtProject" name="txtProject" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtRecpName" name="txtRecpName" autocomplete="off"  placeholder="" value="" required>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtContactName2" name="txtContactName2" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                                                                                
                                                <div class="col-md-2 txtLabel">บัตรประชาชน(2)</div>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtCardID2" name="txtCardID2" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtContactName3" name="txtContactName3" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                                                                                
                                                <div class="col-md-2 txtLabel">บัตรประชาชน(3)</div>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtCardID3" name="txtCardID3" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtCheqDate" name="txtCheqDate" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px">                              
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtPercentProcessFee" name="txtPercentProcessFee" autocomplete="off"  placeholder="" value="" required>
                                                </div>

                                                <div class="col-md-2 txtLabel">หักค่าดำเนินการ</div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtAmountProcessFee" name="txtAmountProcessFee" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                                                                                
                                                <div class="col-md-2 txtLabel">คอมมิชชั่นสุทธิ</div>
                                                <div class="col-md-2">
                                                    <input type="text" class="form-control input input-sm txtLabel" id="txtGrandCommission" name="txtGrandCommission" autocomplete="off"  placeholder="" value="" required>
                                                </div>
                                            </div>

                                            <div class="row hidden" style="margin-bottom: 5px">
                                                <div class="col-md-2 txtLabel">สถานะชำระ</div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea cols="40" rows="2" id="txtisRemark" name="txtisRemark" class="form-control input input-sm txtLabel"></textarea>
                                                </div>
                                            </div>
                                            <div class="row hidden" style="margin-bottom: 5px">
                    ...
                    <div class="modal-footer clearfix">
                        <span class="pull-left">
                            <button type="button" id="btnDelete" onserverclick="btnDelete_click" runat="server" class="btn btn-danger" >Delete</button>
                        </span>
