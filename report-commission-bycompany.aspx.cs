...
public partial class report_commission_bycompany : System.Web.UI.Page
{
    ...
    public void btnGetCommission_click(object sender, EventArgs e)
    {
        try
        {
            ...
            strSelectCom = Request.Form["selectCompany"];
            ...
            // todo if case company
            if (strSelectCom == "B")
            {
                Session["selB"] = "selected";
            } else if (strSelectCom == "I")
            {
                Session["selI"] = "selected";

            }
            else if (strSelectCom == "W")
            {
                Session["selW"] = "selected";
            }
    ...
    protected void GetDataSaleCommission(string strstartdate, string strenddate, string strispaid)
    {
        try
        {
            ...
            strCompany = Request.Form["selectCompany"];
            strSearch = Request.Form["txtsearchname"];
            ...
            {
                ssql += " WHERE arDocuDate between '" + strstartdate + "' and  '" + strenddate + "' and isPaid='" + strispaid + "' and  InvNo like '"+ strCompany + "%' and  (ContactName like '%"+ strSearch + "%' or ContactName2 like '%" + strSearch + "%') ";
            }
            else
            {
                ssql += " WHERE arDocuDate between '" + strstartdate + "' and  '" + strenddate + "' and  InvNo like '" + strCompany + "%' and  (ContactName like '%" + strSearch + "%' or ContactName2 like '%" + strSearch + "%') ";
            }

            ssql += " order by InvNo, DocuDate ";
    ...
    protected void btnExportExcel_click(object sender, EventArgs e)
    {
        try
        {
            ...
            ssql = "exec spKeyCut_CommReport22 '" + strstartdate + "',  '" + strenddate + "', '" + strispaid + "', '" + strCompany + "', '" + strSearch + "' ";
    ...
    protected void btnDownload_click(object sender, EventArgs e)
    {
        try
        {
            ...
            ssql = "exec spKeyCut_CommReport33 '" + strstartdate + "', '" + strenddate + "', '" + strispaid + "', '" + strCompany + "', '" + strSearch + "'";
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                rpt.Load(Server.MapPath("pages/reports/rptSaleCommissionCom.rpt"));
                ...
                rpt.SetParameterValue("@strcompany", strCompany);
                rpt.SetParameterValue("@strsearch", strSearch);
